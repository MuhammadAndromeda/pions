...
<div id="mobile"
    ...
    <div class="w-full h-auto mb-10 gap-3 flex flex-col justify-center items-start">
        ...
        <a href="#"
            class="text-lg text-black w-full h-auto px-3 py-2 bg-white font-medium decoration-0 rounded-md capitalize">About
            Us</a>
        <a href="#"
            class="text-lg text-black w-full h-auto px-3 py-2 bg-white font-medium decoration-0 rounded-md capitalize">Services</a>
        <a href="#"
            class="text-lg text-black w-full h-auto px-3 py-2 bg-white font-medium decoration-0 rounded-md capitalize">Doctors</a>
        <a href="#"
            class="text-lg text-black w-full h-auto px-3 py-2 bg-white font-medium decoration-0 rounded-md capitalize">FaQ</a>
    </div>
