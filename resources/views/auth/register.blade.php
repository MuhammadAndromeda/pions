...
<body>
    <section class="w-full h-screen bg-blue-800 relative flex justify-between items-center">
        ...
        <div class="w-160 h-screen px-12 py-10 bg-white border-l-3 border-l-gray-300 flex flex-col justify-start items-start z-10">
            <h1 class="text-5xl text-blue-800 font-medium capitalize mb-12">sign up</h1>
            <form method="post" class="w-full h-auto gap-3 flex flex-col justify-center items-start">
