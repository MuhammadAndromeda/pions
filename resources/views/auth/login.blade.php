...
<body>
    <section class="w-full h-screen bg-blue-800 relative overflow-x-hidden flex flex-col md:flex-row-reverse justify-between items-center">
        ...
        <div class="w-full md:w-auto h-screen px-5 md:px-15 py-10 flex flex-col justify-start items-end z-10">
            ...
            <div class="w-full h-auto flex flex-col justify-center items-end">
                <h1 class="text-5xl md:text-7xl font-medium text-white text-right capitalize mb-6 md:mb-10">Welcome <br>back to Pions</h1>
                <p class="text-sm md:text-lg text-right font-normal text-white capitalize">sign in. stay active. stay inspired</p>
            </div>
        </div>
        ...
        <div class="w-full md:w-auto h-screen px-5 md:px-15 py-8 md:py-10 bg-white border-l-0 md:border-l-3 border-l-transparent md:border-l-gray-300 flex flex-col justify-start items-start z-10">
            ...
            <form method="post" class="w-full h-auto gap-5 flex flex-col justify-center items-start">
                ...
                <div class="w-full h-auto pt-3 gap-0 md:gap-50 flex justify-between md:justify-center items-center">
                    <a href="#" class="text-black text-sm md:text-base font-medium capitalize underline">forgot your password?</a>
                ...
                <div class="w-full h-auto mt-3 md:mt-8 gap-3 flex flex-col justify-center items-center">
                    <button type="submit" class="w-full h-auto mb-1 py-3 text-base text-white capitalize bg-blue-800 rounded-xl border-2 border-blue-800 hover:bg-transparent hover:text-blue-800 transition cursor-pointer">sign in</button>
