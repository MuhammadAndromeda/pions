...
<body class="bg-blue-900 text-white">
    <main class="w-full h-auto px-5 py-15 bg-blue-900 relative overflow-hidden flex flex-col justify-center items-center">
        <header class="w-full h-auto mt-15 gap-10 flex flex-col md:flex-row justify-center items-center">
            <div class="min-w-90 max-w-90 h-auto p-3 border-4 border-black bg-white rounded-3xl relative overflow-hidden flex flex-col justify-center items-center">
                <img src="{{ asset('images/imagev.png') }}" alt="" class="w-80 h-auto max-w-full mb-5">
            ...
            <div class="w-auto h-auto flex flex-col justify-center items-start">
                ...
                <div class="w-auto h-auto mb-5 gap-5 flex justify-start items-center">
                    <a href="#" class="w-25 h-25 text-xs text-white font-nohemi font-medium tracking-wider bg-emerald-600 relative overflow-hidden gap-2 flex flex-col justify-center items-center"><i class="fa-brands fa-instagram text-white text-5xl"></i>@Tubagusva</a>
                    <a href="#" class="w-25 h-25 text-xs text-white font-nohemi font-medium tracking-wider bg-purple-700 relative overflow-hidden gap-2 flex flex-col justify-center items-center"><i class="fa-brands fa-facebook text-white text-5xl"></i>@Tubagusva</a>
                    <a href="#" class="w-25 h-25 text-xs text-white font-nohemi font-medium tracking-wider bg-pink-600 relative overflow-hidden gap-2 flex flex-col justify-center items-center"><i class="fa-brands fa-linkedin text-white text-5xl"></i>@Tubagusva</a>
                </div>
    ...
    <section class="w-full h-auto py-10 bg-blue-900 relative overflow-hidden flex flex-col justify-center items-center">
        ...
        <section class="w-full h-auto px-5 md:px-15 bg-blue-900 gap-6 relative overflow-hidden flex md:grid flex-col md:grid-cols-2 justify-center items-center">
            ...
            <div class="w-max h-auto px-3 md:px-5 py-5 bg-white border-2 border-black rounded-xl gap-5 flex justify-center items-center">
                <img src="{{ asset('images/imagea.png') }}" class="w-30 md:w-60 h-auto max-w-full">
            ...
            <div class="w-max h-auto px-3 md:px-5 py-5 bg-white border-2 border-black rounded-xl gap-5 flex justify-center items-center">
                <img src="{{ asset('images/imagec.png') }}" class="w-30 md:w-60 h-auto max-w-full">
                <div class="w-40 md:w-70 h-auto flex flex-col justify-center items-start">
            ...
            <div class="w-max h-auto px-3 md:px-5 py-5 bg-white border-2 border-black rounded-xl gap-5 flex justify-center items-center">
                <img src="{{ asset('images/imagep.png') }}" class="w-30 md:w-60 h-auto max-w-full">
                <div class="w-40 md:w-70 h-auto flex flex-col justify-center items-start">
            ...
            <div class="w-max h-auto px-3 md:px-5 py-5 bg-white border-2 border-black rounded-xl gap-5 flex justify-center items-center">
                <img src="{{ asset('images/imagey.png') }}" class="w-30 md:w-60 h-auto max-w-full">
                <div class="w-40 md:w-70 h-auto flex flex-col justify-center items-start">
