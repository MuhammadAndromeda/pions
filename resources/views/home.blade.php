...
@section('content')
    ...
    <section class="w-full h-screen bg-blue-900 relative overflow-hidden flex flex-col justify-end items-center">
        ...
        <div
            class="w-full h-auto px-5 gap-5 flex flex-col-reverse md:flex-row justify-end md:justify-between items-center md:items-end z-10">
                ...
                <div id="cardContainer" class="w-max h-auto relative overflow-hidden gap-3 flex">
                    ...
                    @foreach($divisionLeaders as $leaderPionsPosition) {{-- <-- Perubahan di sini: Pakai leaderPionsPosition --}}
                        ...
                        @if ($leaderPionsPosition->member)
                            @php
                                $leader = $leaderPionsPosition->member; // Ambil objek Member
    ...
    <section
        ...
        <h1 class="w-100 md:w-120 text-white text-xl md:text-5xl text-right font-bold font-nohemi capitalize">Welcome to
            pions and here the 4 Pillar <span class="font-medium">of Pions</span></h1>
